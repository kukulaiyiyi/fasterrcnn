...
def create_model(num_classes):
    ...
    backbone = MobileNetV2(weights_path="./backbone/mobilenet_v2-b0353104.pth").features  #weights_path="./backbone/mobilenet_v2.pth"
...
def main():
    ...
    VOC_root = r"D:\Dataset"  # VOCdevkit
    aspect_ratio_group_factor = 3
    batch_size = 2

    # check voc root
    if os.path.exists(os.path.join(VOC_root, "DOTA_vehicle")) is False:
        raise FileNotFoundError("DOTA_vehicle dose not in path:'{}'.".format(VOC_root))
